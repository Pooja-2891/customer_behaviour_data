...
from customer_modified
group by gender; 

#which customers used a discount but still spent more than the average purchse amount
select customer_id, purchase_amount 
from customer_modified
where discount_applied = 'Yes' and 
purchase_amount >= (select AVG(purchase_amount) from customer_modified);
